# RepairsListener.Tests

This is the test project for the RepairsListener application.
...
See the [BaseSteps class](/RepairsListener.Tests/E2ETests/Steps/BaseSteps.cs) for more details.
