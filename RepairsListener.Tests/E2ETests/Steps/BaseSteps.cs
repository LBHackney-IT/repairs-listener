...
namespace RepairsListener.Tests.E2ETests.Steps
{
    public class BaseSteps
    {
        ...
        protected SQSEvent.SQSMessage CreateMessage(Guid personId, string eventType = EventTypes.AddRepairsContractsToAssetEvent)
        {
